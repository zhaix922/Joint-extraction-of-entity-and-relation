...
class GLCN(nn.Module):
    ...
    def __init__(self,
        ...
        self.alpha_transform = nn.Linear(num_relation_type, in_dim, bias=False)

    def forward(self, x: Tensor, rel_features: Tensor, adj: Tensor, box_num: Tensor = None, **kwargs):
        '''
